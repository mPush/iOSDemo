...
+ (void)startPushService:(NSDictionary *)launchOptions
     ...
     deviceTokenDelegate:(id <DeviceTokenDelegate>)deviceTokenDelegate
             customViews:(NSDictionary *)displaysMap  __attribute__((deprecated("Use +startPushServiceWithDelegate:tokenDelegate:customViews: instated")));


+ (void)startPushServiceWithDelegate:(id <PushManagerDelegate>)pushDelegate
